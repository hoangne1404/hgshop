          ...
          return `
            <div class="order-item">
              <div class="order-item-image">
                <img src="${item.image && item.image.startsWith('http') ? item.image : 'images/sanpham/' + (item.image || 'default-product.png')}" alt="${item.name}" onerror="this.src='images/default-product.png'">
              </div>
